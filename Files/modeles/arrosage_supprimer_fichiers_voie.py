...
fichiers_a_supprimer = [
    os.path.join(dossier_destination, f"voie_{max_num}.yaml"),
    os.path.join(dossier_destination, f"script_arrosage_declenchement_auto_voie_{max_num}.yaml"),
    os.path.join(dossier_destination, f"automatisation_arrosage_voie_{max_num}.yaml"),
]
