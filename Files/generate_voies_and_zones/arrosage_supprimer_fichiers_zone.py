...
if max_num == 0:
    print("⚠️ Aucun fichier zone_X.yaml trouvé.", file=sys.stderr)
    sys.exit(1)

if max_num == 1:
    print("⚠️ Vous ne pouvez pas supprimer les fichiers de la zone 1.", file=sys.stderr)
    sys.exit(1)

# --- Liste des fichiers à supprimer ---
fichiers_a_supprimer = [
    os.path.join(DOSSIER, f"zone_{max_num}.yaml"),
    os.path.join(DOSSIER, f"automatisation_arrosage_zone_{max_num}.yaml"),
]
